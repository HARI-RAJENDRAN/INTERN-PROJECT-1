...
OUTPUT_DIR = r"C:\Users\Yogesh\Downloads\HARI_CHARLEZ\generated_pds"
FONT_PATH = r"C:\Users\Yogesh\Downloads\HARI_CHARLEZ\DejaVuSans.ttf"
LOGO_PATH = r"C:\Users\Yogesh\Downloads\HARI_CHARLEZ\logo.png"
CORNER_IMG_PATH = r"C:\Users\Yogesh\Downloads\HARI_CHARLEZ\corner.png"
CORNER_IMG_PATH_1 = r"C:\Users\Yogesh\Downloads\HARI_CHARLEZ\corner1.png"
SIGN_IMG = r"C:\Users\Yogesh\Downloads\HARI_CHARLEZ\sign.png"
    ...
    if user["Email"]:
        if user["Email"] not in sent_emails:
            try:
                ...
                # ✅ Update Google Sheet status via Webhook
                                # ✅ Update Google Sheet status via Webhook
                # In your email sending section:
                try:
                    payload = {
                        "email": user["Email"].lower().strip(),  # Clean the email
                        "status": "Mail Sent"  # Exact status text you want
                    }
                    response = requests.post(STATUS_UPDATE_WEBHOOK, data=payload)
